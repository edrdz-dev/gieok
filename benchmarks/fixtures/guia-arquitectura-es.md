# Guia de arquitectura (fixture del benchmark)

> Este documento existe para que el corpus del benchmark mezcle idiomas, que es la
> condicion bajo la cual se eligio el modelo de embeddings por defecto. Es la version
> original en espanol de las directrices del proyecto; la vigente es CLAUDE.md, en
> ingles. No lo edites para reflejar cambios del proyecto: el ground truth de
> `benchmarks/questions.py` depende de esta redaccion exacta.
